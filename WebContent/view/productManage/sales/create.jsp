...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(msg) {
				...
				if (0 == json.flag) {
					...
					$("#product_standard").html(json.prodStandard);
	...
	function product_calculate(num) {
		...
		var varOtherMoney =  $("#discount_price").val();
		//折扣额
		...
		if (vproAmount != "" && vproduct_retailPrice != ""
			...
			if(varOtherMoney!=null){
				$("#totalMoney").val(
						Number(vproAmount) * Number(vproduct_retailPrice)
								- Number(varProduct_rate_money)+Number(varOtherMoney));
			}else{
				$("#totalMoney").val(
						Number(vproAmount) * Number(vproduct_retailPrice)
								- Number(varProduct_rate_money));
		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix">
				<div class="heading clearfix">
					<i class="icon-reorder"></i> 新增销售单 <a href="javascript:;"
								...
								<tr>
									<td class="form-inline"><label>客户：</label> <input
										...
										<div style="float: right;">
											...
											<!-- 
											<input type="text" class="form-control" value="小明" disabled>
											<input type="hidden" name="operator" value="2" /> -->
											<input type="hidden" name="status" value="2" /> <input
												type="hidden" name="orederType" value="1" />
										</div></td>
								</tr>
							</table>
							<div class="row-fluid">
										...
										<tbody>
											...
											<tr style="background-color: #FFFFF1">
												...
												<td colspan="2"><input type="text"
													...
													onkeyup="product_calculate('1')"></td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
