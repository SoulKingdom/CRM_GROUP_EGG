		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix mwi1200">
				...
				<div class="widget-content padded clearfix">
					<form id="create_task_id" class="form-horizontal" action="task.do"
						method="post">
						...
						<div class="form-group field-task-status">
							...
							<div class="col-sm-8">
								<select id="task-status" class="form-control" name="status">
									...
									<option value="10">推迟</option>
									<option value="20">进行</option>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"></label> <input
								type="hidden" name="method" value="addTask" />
							<div class="col-lg-10">
							...
							<c:forEach items="${linkManList }" var="linkManList">
								<tr>
									<td><input type="radio" name="linkMan" style="opacity: 1;"
										value="${linkManList.linkManId }" /></td>
									<td>${linkManList.name }</td>
									<td>${linkManList.sex }</td>
									<td>${linkManList.nickName }</td>
							...
							<c:forEach items="${principalVoList }" var="principalVoList">
								<tr>
									<td><input type="radio" name="employeeDto"
										style="opacity: 1;" value="${principalVoList.employeeId }" /></td>
									<td>${principalVoList.employeeName }</td>
