				...
				<div class="widget-content padded clearfix">
					<form method="post" action="" id="writeForm">
						...
						<div class="form-group clearfix">
							<span class="pull-left">负责人：${individualTaskVo.principal}</span>
						</div>


						<div class="form-group clearfix">
							<span class="pull-left">创建时间：${individualTaskVo.createTime}
							</span>
						</div>

						<div class="form-group clearfix">
							<span class="pull-left">结束时间：${individualTaskVo.endTime}</span>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" name="mailContent" class="form-control"
									value="${individualTaskVo.topic}" readonly="readonly">
							</div>
						</div>

						<div class="form-group">
							<h5 style="margin-top: 30px">任务详情</h5>
							<textarea class="form-control" readonly style="height: 200px">${individualTaskVo.description}</textarea>
						</div>
					</form>
				</div>
			</div>
