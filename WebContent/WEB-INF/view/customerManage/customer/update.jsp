				...
				<div class="widget-content padded clearfix">
					<form id="w0" class="form-horizontal"
						...
						<div class="form-group field-customer-owner_name">
							...
							<div class="col-sm-8">
								<input type="hidden" id="customerId" value="1" /> <input
									...
									value="${customerVo.name}" dialog-size="large"
						...
						<div class="form-group field-customer-customer_industry required">
							...
							<div class="col-sm-8">
								<input type="hidden" id="fieldId" value="${customerVo.fieldId}" />
								<select id="FIELD_ID" class="form-control"
									name="Customer[customer_industry]">
									<option value="">请选择...</option>
									<!--<c:forEach items="${workingField}" var="workingField">
										<option valsue="${workingField.fieldId }">${workingField.fieldName}</option>
									</c:forEach>-->
									<option value="1">集团/上市公司</option>
									<option value="2">大型企业</option>
									<option value="3">设计院/研究所</option>
									<option value="4">政府/学校/社团</option>
									<option value="5">成长性企业</option>
						...
						<div class="form-group field-customer-annual_revenue">
							...
							<div class="col-sm-8">
								<input type="hidden" id="busubessVolume"
									value="${customerVo.busubessVolume }" /> <select
						...
						<div class="form-group field-customer-customer_tag required">
							...
							<div class="col-sm-8">
								<input type="text" id="TAG" class="form-control"
									name="Customer[customer_tag]" value="${customerVo.tag}"
						...
						<div class="form-group field-customer-customer_remarks">
							...
							<div class="col-sm-8">
								<textarea id="REMARKS" class="form-control"
									...
									placeholder="备注">${customerVo.remarks}</textarea>
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						...
						<tbody>
							<c:forEach items="${principalVoList}" var="principalVoList">
								<tr>
									...
									<td id="${principalVoList.employeeId}_lg">${principalVoList.employeeName}</td>
