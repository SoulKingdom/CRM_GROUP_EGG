...
<body class="navbar-top">
						...
						<div class="form-group field-customer-owner_name">
							...
							<div class="col-sm-8">
								<input type="text" id="PRINPICAL"
									class="owner_name form-control weiBoxs-dialog" name="PRINPICAL"
									readonly="readonly" dialog-size="large" dialog-title="选择所属人"
							...
							<div class="col-sm-8">
								...
								<select id="FIELD_ID" class="form-control" name="FIELD_ID">
									...
									<c:forEach items="${workingField}" var="workingField">
										<option value="1">${workingField.fieldName}</option>
									</c:forEach>
								</select>
							...
							<div class="radio-list col-sm-8">
								<div id="customer-customer_origin">
									<label class="label-radio inline"> <input type="radio"
										...
										checked> <span class="custom-radio"></span>网络营销
	...
	function postCheckDocInfo(){
		...
		if (data.BUSUBESS_VOLUME!=null&&data.BUSUBESS_VOLUME!=""&&data.BUSUBESS_VOLUME!="undefined") {
