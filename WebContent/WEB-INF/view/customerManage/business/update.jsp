...
<body class="navbar-top">
		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix mwi1200">
				<div class="heading clearfix">
					<i class="icon-reorder"></i> 修改商机 <a href="javascript:;"
					...
					<form id="w0" class="form-horizontal"
						...
						<div class="form-body">
							...
							<div class="form-group field-business-owner_name">
								...
								<div class="col-sm-8">
									<input type="hidden" d="business-owner_name"
										value="${businessVo.employeeName }" /> <input type="text"
										id="business-owner_name2"
										class="owner_name form-control weiBoxs-dialog"
										name="Business[owner_name]"
										value="${businessVo.employeeName }" dialog-size="large"
							...
							<div class="form-group field-business-selectcustomer required">
								...
								<div class="col-sm-8">
									<input type="hidden" value=1 id="customerId" /> <input
										type="text" id="business-selectcustomer"
										onclick="selectCustomer()"
										class="selectCustomer form-control weiBoxs-dialog"
										name="Business[selectCustomer]"
										value="${businessVo.customerName }" placeholder="点击选择客户"
							...
							<div class="form-group field-business-selectcontacts required">
								...
								<div class="col-sm-8">
									<input type="hidden" id="linkManId" value="1" /> <input
										type="text" id="business-selectcontacts"
										onclick="selectLinkMan()"
										class="selectContacts form-control weiBoxs-dialog"
										name="Business[selectContacts]" value="${businessVo.name }"
										placeholder="点击选择联系人" dialog-title="选择联系人" dialog-size="large"
										dialog-url="/contacts/dialog-list.html">
								</div>
								<div class="help-block help-block-error"></div>
							</div>
							<div class="form-group field-business-name required">
								...
								<div class="col-sm-8">
									<input type="text" id="business-name" class="form-control"
										name="Business[name]" value="${businessVo.businessName }"
										onfocus="$(this).onlypressnum();" placeholder="商机名">
								</div>
								<div class="help-block help-block-error"></div>
							</div>
							<div class="form-group field-business-type required">
								...
								<div class="col-sm-8">
									<input type="hidden" id="sjlx" value="${businessVo.typeId }">
							...
							<div class="form-group field-business-status required">
								...
								<div class="col-sm-8">
									<input type="hidden" id="status22"
										value="${businessVo.status }"> <select
										id="business-status" class="form-control"
							...
							<div class="form-group field-business-origin required">
								...
								<div class="col-sm-8">
									<input type="hidden" id="sjly" value="${businessVo.sourceId}">
							...
							<div class="form-group field-business-gain_rate required">
								...
								<div class="col-sm-8">
									<input type="text" id="business-gain_rate" class="form-control"
										name="Business[gain_rate]" value="${businessVo.probability}"
										onfocus="$(this).onlypressnum();" placeholder="赢单率">
							...
							<div class="form-group field-business-nextstep_time required">
								...
								<div class="col-sm-8">
									...
									<input type="text" id="business-nextstep_time"
										class="form-control form_datetime"
										name="Business[nextstep_time]" onclick="changeType()"
										value="${businessVo.visitTime} " />
								</div>
								<div class="help-block help-block-error"></div>
							</div>
							<div class="form-group field-business-nextstep required">
								...
								<div class="col-sm-8">
									<textarea id="business-nextstep" class="form-control"
										...
										placeholder="下次联系内容">${businessVo.visitContent}</textarea>
								</div>
								<div class="help-block help-block-error"></div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="hidden" id="businessId"
									value="${businessVo.businessId}">
								<button type="button" class="btn btn-primary"
									onclick="updateBuiness()">修改</button>
							...
							<c:forEach items="${linkManList}" var="linkManList">
								<tr>
									<td><input type="radio" name="radioName"
										...
										id="${linkManList.linkManId}" /></td>
									<%-- <td id="${principalVoList.employeeId}_lg">${principalVoList.employeeName}
										</td>
										<td>${principalVoList.departmentName}</td>
										<td>${principalVoList.phoneNum}</td> --%>
									<td id="${linkManList.linkManId}_lg">${linkManList.name}</td>
									<td>${linkManList.position}</td>
									<td>${linkManList.phoneNum}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
	...
	<!-- 	客户模态框 -->
	<div class="modal fade" id="myModalCustomer" tabindex="-1"
				...
				<div class="modal-body">
					<table id="exampleCustomer" class="table">
						...
						<tbody>
							...
							<c:forEach items="${customerVoList}" var="customerVoList">
								<tr>
									<td><input type="radio" name="radioNameCustomer"
										style="opacity: 1; margin-top: -6px"
										id="${customerVoList.customerId}" /></td>
									<td id="${customerVoList.customerId}_gk">${customerVoList.customerName}

									</td>
									<td>${customerVoList.fieldName}</td>
									<td>${customerVoList.sourceName}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
