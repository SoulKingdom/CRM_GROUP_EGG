				...
				<div class="widget-content padded clearfix">
					<form id="create_task_id" class="form-horizontal"
						...
						<div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="text" id="topic_id" class="form-control"
									value="尼古拉斯赵四" name="topic" maxlength="40" placeholder="创建人"
									readonly="readonly" /> <input type="hidden" id="creator"
									value="2" />
							</div>
						</div>
						...
						<div class="form-group field-task-subject required">
							...
							<div class="col-sm-8">
								<input type="date" id="topic_id" class="form-control"
									value="${sessionScope.currentUser.employeeName }" name="topic"
									maxlength="40" placeholder="创建人" /> <input type="hidden"
									id="creator" value="2" />
							</div>
						</div>
						<div class="form-group field-task-content">
