		...
		<div class="container-fluid main-content">
			<div class="widget-container fluid-height clearfix mwi1200">
				<div class="heading clearfix">
					<i class="icon-reorder"></i> 修改联系人 <i class="icon-reply pull-right"
						onclick="history.go(-1);"></i>
				</div>
				<div class="widget-content padded clearfix">
					<form id="actionform" class="form-horizontal"
						action="view/customerManage/contacts/index.jsp" method="get">
						<input type="hidden" name="_csrf"
							value="d2JWMWFEWmEVFQBaWD0ZGSYMZmEsfDUqKAgnVA0UMzkANhh5EwIgVg==">
...
<!--                                    dialog-url="/customer/dialog-list.html"> -->
						...
						<div class="form-group field-contacts-name required">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-name" class="form-control"
									name="Contacts[name]" value="${linkMan.name }" maxlength="20"
									placeholder="姓名">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-contacts-sex required">
							...
							<div class="col-sm-8">
								<input type="hidden" name="Contacts[sex]" id="sexid"
									value="${linkMan.sex }">

								<div id="contacts-sex">
									<label class="label-radio inline"> <input type="radio"
										name="Contacts[sex]" value="1" id="nanId"> <span
										class="custom-radio"></span>男
									</label> <label class="label-radio inline"> <input type="radio"
										name="Contacts[sex]" value="2" id="nvID"> <span
										class="custom-radio"></span>女
									</label>
								</div>
							</div>
							<div class="help-block help-block-error"></div>
						...
						<div class="form-group field-contacts-honorific required">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-honorific" class="form-control"
									name="Contacts[honorific]" value="${linkMan.nickName }"
						...
						<div class="form-group field-contacts-post">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-post" class="form-control"
									name="Contacts[post]" value="${linkMan.position }"
						...
						<div class="form-group field-contacts-mobile required">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-mobile" class="form-control"
									name="Contacts[mobile]" value="${linkMan.phoneNum}"
									placeholder="手机" maxlength="11">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-contacts-email required">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-email" class="form-control"
									name="Contacts[email]" value="${linkMan.email }"
									placeholder="电子邮箱">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-contacts-qq">
							...
							<div class="col-sm-8">
								<input type="text" id="contacts-qq" class="form-control"
									name="Contacts[qq]" value="${linkMan.QQ}" placeholder="QQ">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group field-contacts-remarks">
							...
							<div class="col-sm-8">
								<textarea id="contacts-remarks" class="form-control"
									name="Contacts[remarks]" maxlength="255" placeholder="备注">${linkMan.remarks }</textarea>
							</div>
							<div class="help-block help-block-error"></div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								...
								<button type="button" class="btn btn-primary"
									onclick="updatLinkMan('${linkMan.linkManId}')">修改</button>
...
/* function selectCustomer(){
	...
	function updatLinkMan(linkManId){
	var data={};
...
// 	}
	...
	$.ajax({
		   type: 'post',
           url: 'LinkManServlet?method=updateLinkMan&linkManId='+linkManId,
           data: data,
           cache: false,
           sync: true,
