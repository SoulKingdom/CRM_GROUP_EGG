...
<body class="navbar-top">
								...
								<tbody>
									<c:forEach items="${menuList}" var="menuList">
										<tr data-key="1">
											...
											<td>${menuList.pictures }</td>
											<td>${menuList.createTime }</td>
											<td>${menuList.updateTime }</td>
											<td>${menuList.parentMenuId }</td>
											<td>
	...
	function updateMenu(menuId){
		location.href='MenuServlet?method=getUpdateMenudetailById';
	}
</script>
</body>
