...
<body class="navbar-top">
			...
			<div class="widget-container fluid-height clearfix">
				<div class="heading clearfix">
					<i class="icon-table"></i> 职位设置 <a
						...
						href="EmmPositionServlet?method=addPosition" dialog-title="添加职位"><i
					...
					<div id="w0" class="grid-view">
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									<c:forEach items="${emmPositionList}" var="emmPositionList">
										<tr>
											<td>${emmPositionList.positionId }</td>
											<td>${emmPositionList.positionName }</td>
											<td>${emmPositionList.positionLevel }</td>
											<td>${emmPositionList.createTime }</td>
											<td>${emmPositionList.updateTime }</td>
											<td>
												<div class="col-lg-20">
													...
													<button type="button" id="linkbtn" name="linkbtn"
														...
														onclick="showselectmodel(1)">关联菜单</button>
												</div>
											</td>
										</tr>
									</c:forEach>
									<!-- <tr>
										...
										<td>
											<div class="col-lg-20">
												...
												<button type="button" id="linkbtn" name="linkbtn"
													class="btn btn-success btn-sm" onclick="showselectmodel(2)">关联菜单</button>
											</div>
										</td>
									</tr> -->
								</tbody>
	...
	<script type="text/javascript">
		function deleteposition(positionId) {
			...
			$.ajax({
				type : 'post',
				url : 'EmmPositionServlet?method=deletePostionCheck',
				data : data,
				cache : false,
				sync : true,
				success : function(msg) {
					...
					if (0 == json.status) {
						...
						location.href = 'EmmPositionServlet?method=deletePosition&positionId='
								+ positionId;
					}
				},
				error : function() {
	...
	<script type="text/javascript">
		function updateposition(positionId) {
			location.href = 'EmmPositionServlet?method=getUpdatePostionDetailById&positionId='
					+ positionId;
		...
		function submittochange() {
			...
			window.location.href = 'EmmPositionServlet?method=positionLinks&menuIds='
