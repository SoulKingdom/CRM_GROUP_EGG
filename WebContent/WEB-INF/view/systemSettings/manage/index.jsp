						...
						<form class="form-inline"
							...
							<div class="btn-group">
								<span>姓名：</span> <input type="text" class="form-control"
									id="emmployeename" name="emmployeename" value="">
							</div>
							<div class="btn-group">
								...
								<tbody>
									<c:forEach items="${employeeList}" var="employeeList">
										<tr data-key="1">
											...
											<td>${employeeList.positonId }</td>
											<td>${employeeList.phone }</td>
											<td>${employeeList.email }</td>
											<td>${employeeList.parentEmployeeId }</td>
											<td>${employeeList.createTime }</td>
											<td>${employeeList.updateTime }</td>
											<td>
												<button type="button" id="recevorbtn" name="recevorbtn"
													class="btn btn-success btn-sm"
													onclick="updateEmployeeStatus('1','1')">恢复正常</button>
												<button type="button" id="forbidbtn" name="forbidbtn"
													class="btn btn-danger btn-sm"
													onclick="updateEmployeeStatus('2','0')">禁用账户</button>
												<button type="button" id="updatebtn" name="updatebtn"
													class="btn btn-info btn-sm"
													onclick="updateEmployeeDetail('2')">修改用户信息</button>
											</td>
										</tr>
									</c:forEach>
									<!-- <tr data-key="1">
